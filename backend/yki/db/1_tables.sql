...
--
-- Name: free_attachment; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.free_attachment (
    free_attachment_id bigint NOT NULL,
...
ALTER TABLE public.free_attachment OWNER TO admin;

--
-- Name: free_attachments_free_attachment_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.free_attachment ALTER COLUMN free_attachment_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.free_attachments_free_attachment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: free_attachments_free_registration_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.free_attachment ALTER COLUMN free_registration_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.free_attachments_free_registration_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: free_comment; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.free_comment (
    free_comment_id bigint NOT NULL,
    free_registration_id bigint NOT NULL,
...
ALTER TABLE public.free_comment OWNER TO admin;

--
-- Name: free_comment_free_comment_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.free_comment ALTER COLUMN free_comment_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.free_comment_free_comment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.free_registration (
    ...
    is_finnish boolean DEFAULT true,
    is_foreign boolean,
    version integer DEFAULT 0 NOT NULL,
    created_by text,
    modified_by text,
...
--
-- Name: free_supplement_req; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.free_supplement_req (
    free_supplement_req_id bigint NOT NULL,
    free_registration_id bigint NOT NULL,
...
ALTER TABLE public.free_supplement_req OWNER TO admin;

--
-- Name: free_supplement_req_free_supplement_req_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

ALTER TABLE public.free_supplement_req ALTER COLUMN free_supplement_req_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.free_supplement_req_free_supplement_req_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
