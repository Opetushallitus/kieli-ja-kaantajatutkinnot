...
public enum APIExceptionType {
  ...
  QUARANTINE_DIARY_NUMBER_ALREADY_EXISTS,
  QUARANTINE_INVALID_DATE_ORDER,
  QUARANTINE_ALREADY_DELETED,
  STATISTICS_MISSING_DATE_RANGE,
  STATISTICS_INVALID_DATE_ORDER,
  STATISTICS_EMPTY_RESULT;
