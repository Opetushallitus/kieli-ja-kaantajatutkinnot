...
import fi.oph.yki.service.email.EmailAttachmentData;
...
class EmailSenderViestintapalveluTest {
  ...
  public void setup() {
    ...
    sender =
      new EmailSenderViestintapalvelu(
        ...
        "yki",
        "Yleiset kielitutkinnot | Opetushallitus"
      );
  }
  ...
  public void test() throws JsonProcessingException, InterruptedException {
    ...
    assertThat(body).extractingJsonPathStringValue("$.email.callingProcess").isEqualTo("yki");
    assertThat(body)
      .extractingJsonPathStringValue("$.email.sender")
      .isEqualTo("Yleiset kielitutkinnot | Opetushallitus");
