...
pg_dump --host=localhost --port=6432 --username=postgres --table=exam_language --table=exam_level --table=enrollment_status --table email_type --data-only vkt-postgres > 2_tables_data.sql
