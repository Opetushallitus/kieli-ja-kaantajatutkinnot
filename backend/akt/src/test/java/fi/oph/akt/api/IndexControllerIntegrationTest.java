...
class IndexControllerIntegrationTest {
  ...
  public void testStaticAssetIsReturned() throws Exception {
    final String expectedContent = TestUtil.readResourceAsString("static/akt/static/assets/svg/akt_logo.svg");
    assertGetContent("/akt/static/assets/svg/akt_logo.svg", "image/svg+xml", expectedContent);
  }
