...
FRONTEND_PATH=../../../frontend/packages/akt/public/i18n/koodisto/postal_codes

mkdir -p $FRONTEND_PATH
curl -H "Caller-Id:kehittaja-akt" "https://virkailija.opintopolku.fi/koodisto-service/rest/json/posti/koodi" --create-dirs -o $KOODISTO_FILE
...
function extract_frontend_localisation() {
  ...
  jq_obj_wrap_cmd='. | {akt:{koodisto:{postalCodes:.}}}'
