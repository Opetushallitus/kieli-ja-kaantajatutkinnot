...
class EmailSenderViestintapalveluTest {
  ...
  public void test() throws JsonProcessingException, InterruptedException {
    ...
    assertThat(body).extractingJsonPathStringValue("$.email.callingProcess").isEqualTo("otr");
    assertThat(body).extractingJsonPathStringValue("$.email.sender").isEqualTo("Oikeustulkkirekisteri");
