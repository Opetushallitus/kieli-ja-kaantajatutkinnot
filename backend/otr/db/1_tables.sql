...
--
-- Name: interpreter_interpreter_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.interpreter ALTER COLUMN interpreter_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.interpreter_interpreter_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.qualification ALTER COLUMN qualification_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.qualification_qualification_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
