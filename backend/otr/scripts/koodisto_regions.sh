...
KOODISTO_FILE=../src/main/resources/koodisto/koodisto_maakunta.json
FRONTEND_PATH=../../../frontend/packages/otr/public/i18n/koodisto/regions

mkdir -p $FRONTEND_PATH
curl -H "Caller-Id:kehittaja-otr" "https://virkailija.opintopolku.fi/koodisto-service/rest/json/maakunta/koodi" --create-dirs -o $KOODISTO_FILE
...
function extract_frontend_localisation() {
  ...
  jq_obj_wrap_cmd='. | {otr:{koodisto:{regions:.}}}'
