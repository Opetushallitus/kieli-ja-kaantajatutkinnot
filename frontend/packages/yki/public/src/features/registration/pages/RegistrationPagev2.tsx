...
import { PublicExamSessionFilters } from 'features/registration/components/examSession/PublicExamSessionListingFiltersv2';
import { PublicExamSessionListing } from 'features/registration/components/examSession/PublicExamSessionListingv2';
import { useRegistrationStartNavigation } from 'features/registration/hooks/useRegistrationStartNavigationv2';
import {
  useAppDispatch,
  useAppSelector,
...
export const RegistrationPage: FC = () => {
  useRegistrationStartNavigation();
  const { t } = usePublicTranslation({
